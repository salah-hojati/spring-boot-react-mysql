...
import { BrowserRouter as Router, Route, Routes, Link, useNavigate, useParams } from 'react-router-dom'; // Added useParams here
...
const ItemForm = ({ isEditing }) => {
  ...
  const navigate = useNavigate();
  // Call useParams unconditionally at the top level
  const params = useParams();
  const id = isEditing ? params.id : null; // Conditionally access the id
